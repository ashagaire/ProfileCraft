        ...
        <div className="relative pl-4 md:pl-12 ">
          {experienceItems.map((exp) => (
            <div key={exp.id} className=" ">
              ...
              <Card className="ml-2 md:ml-4"  sx={{borderWidth: "1px", borderStyle: "solid", borderColor: "#e5e7eb" }}>
                <CardContent >
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                    ...
                    <div className="mt-2 md:mt-0 md:text-right">
                      <Button variant="contained" size="small" className="custom-button-badge text-sm px-3 py-1">
                        {exp.period}
                      </Button>
                    </div>
                  </div>
